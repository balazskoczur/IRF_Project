...
namespace Project {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(int Id, string Name, string Phone, string Email) {
...
namespace Project.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Name], [Phone], [Email]) VALUES (@Id, @Name, @P" +
                "hone, @Email);\r\nSELECT Id, Name, Phone, Email FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [Id] = @Id, [Name] = @Name, [Phone] = @Phone, [Email] = " +
                "@Email WHERE (([Id] = @Original_Id));\r\nSELECT Id, Name, Phone, Email FROM [Table" +
                "] WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Phone, Email FROM dbo.[Table]";
        ...
        public virtual int Update(int Id, string Name, string Phone, string Email, int Original_Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Phone, string Email, int Original_Id) {
            return this.Update(Original_Id, Name, Phone, Email, Original_Id);
        }
    }
